...
$(document).ready(function () {
    ...
    isShowexcludedEnabled = GLOBAL_JSON.hasOwnProperty('showexcluded');
...
function getCE(data) {
    ...
    data.forEach(function (item) {
        if (((covType === 'Conditions' && (!item[CONDEXP_ITEM.TYPE])) || (covType === 'Expressions' && (item[CONDEXP_ITEM.TYPE])) ) && (!((typeof item[CONDEXP_ITEM.COV_PERCENTAGE] === 'string') && (!item.t.length))) && (!((item[CONDEXP_ITEM.EXCLUDED]) && !( isShowexcludedEnabled ))) ) {
