...
function processGlobaljson() {
    ...
    GLOBAL_JSON = {
        ...
        byDu: g_oCONST.hasOwnProperty('commandargs') ?
            (checkCommandArgs(g_oCONST.commandargs, '-du') || checkCommandArgs(g_oCONST.commandargs, '-bydu')) : undefined,                          // by Du
...
function isTogglesExtendedValueExcluded(params) {
    return (typeof params.data.lToH === 'string') || (typeof params.data.hToL === 'string') || (typeof params.data.lToZ === 'string') || (typeof params.data.zToH === 'string') || (typeof params.data.hToZ === 'string') || (typeof params.data.zToL === 'string') || (typeof params.data.hits === 'string');
}
...
function getPageTemplate() {
    ...
    var BODY_TEMPLATE =
        '<div id="page-header-container">' +
            ...
            '</a>' +
            '<a id="duList" style="padding: 2px 0 0px 0px;margin-right:50px; ' + ( ((GLOBAL_JSON.byInstance && ! GLOBAL_JSON.byDu) || (GLOBAL_JSON.pa && !GLOBAL_JSON.paCombined)) ? 'display: none' : '') + ' " title="Design Units" class="home-logo" href="dulist.html">' +
 ...
 */
var gridOptionsList = {};
function createDataGridInstance(id, columnDefs, rowData, config, height) {
    if (height === undefined) {
        height = false;
    }
    var options = {};
    ...
    if (options && options.hasOwnProperty('paginationEnabled')) {
        ...
        if (nEntries.totalCount == 1 || nEntries.totalCount == 2) {
...
function ExportFormattingFunction (params) {
    if ((params.column.getColId() === 'hit' || params.column.getColId() === 'miss' || params.column.getColId() === 'cp') && (isValueNa(params))) {
        return 'na';
