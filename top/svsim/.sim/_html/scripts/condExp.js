...
function getCE(data) {
    ...
    data.forEach(function (item) {
        if (((covType === 'Conditions' && (!item[CONDEXP_ITEM.TYPE])) || (covType === 'Expressions' && (item[CONDEXP_ITEM.TYPE])) ) && (!((typeof item[CONDEXP_ITEM.COV_PERCENTAGE] === 'string') && (!item.r.length))) && (!((item[CONDEXP_ITEM.EXCLUDED]) && !( isShowexcludedEnabled ))) ) {
